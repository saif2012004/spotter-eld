...
# Comma-separated in env; default '*' so local dev works without any .env
...
# CORS: open in dev, explicit whitelist in prod (set CORS_ALLOWED_ORIGINS in env)
if DEBUG:
...
# ---------------------------------------------------------------------------
# Logging — structured to stdout; Render/Gunicorn capture it automatically
# ---------------------------------------------------------------------------
LOGGING = {
    'version': 1,
